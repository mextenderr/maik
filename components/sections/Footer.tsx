    ...
    <footer className="bg-[#0f2a4a] text-white px-6 md:px-8 lg:px-12 py-16 md:py-20 lg:py-24">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-white/40">
          <p>&copy; {new Date().getFullYear()} Maik van Velthoven. Alle rechten voorbehouden.</p>
          <div className="flex gap-6">
            <a href="#" className="hover:text-white/60 transition-colors">Privacybeleid</a>
            <a href="#" className="hover:text-white/60 transition-colors">Algemene voorwaarden</a>
          </div>
        </div>
      </div>
    </footer>
